...
(function ($) {
    ...
    function jqCron(settings) {
        ...
        var _$blockTIME = $('<div style="display: inline" class="jqCron-time"></div>');
        var _$cross = $('<span class="jqCron-cross">&#10008;</span>');
        var _selectors = [];
        var _selectorPeriod, _selectorSecs, _selectorMins, _selectorTimeH, _selectorTimeM, _selectorTimeS, _selectorDow,
            _selectorDom, _selectorMonth;
        ...
        this.setCron = function (str) {
            ...
            try {
                ...
                else if (mask.substring(4, mask.length) == '-*') {
        ...
        this.init = function () {
            ...
            for (i = 0, list = settings.seconds; i < list.length; i++) {
